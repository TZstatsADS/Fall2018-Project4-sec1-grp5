...
for (i in 1:length(group)) {
  ...
  write.csv(dict, file = paste0(paste0(path, "group1"),".csv"))
  write.csv(dict, file = paste0(paste0(path, "group2"),".csv"))
  write.csv(dict, file = paste0(paste0(path, "group3"),".csv"))
  write.csv(dict, file = paste0(paste0(path, "group4"),".csv"))
  write.csv(dict, file = paste0(paste0(path, "group5"),".csv"))
```
